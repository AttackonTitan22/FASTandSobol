...
X = rbdfast_sample.sample(problem, 5000)
...
print(Si['S1'])
# 将本次数据存入文件中
csv_file = open('../Performance for large number of important factors and comparison with the classic FAST/rbdfast5000.csv', 'w', newline='')
